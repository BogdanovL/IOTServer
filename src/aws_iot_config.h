...
#ifndef AWS_IOT_INCLUDES_AWS_IOT_CONFIG_H_
#define AWS_IOT_INCLUDES_AWS_IOT_CONFIG_H_


// Get from console
// =================================================
#define AWS_IOT_MQTT_HOST              "a2v38yak7ttgi3.iot.us-west-2.amazonaws.com" ///< Customer specific MQTT HOST. The same will be used for Thing Shadow
...
#define AWS_IOT_MY_THING_NAME 		   "LennyHomeMQTTBridge" ///< Thing Name of the Shadow this device is associated with
#define AWS_IOT_ROOT_CA_FILENAME       "rootCA" ///< Root CA file name
#define AWS_IOT_CERTIFICATE_FILENAME   "2afaa99581-certificate.pem.crt" ///< device signed certificate file name
#define AWS_IOT_PRIVATE_KEY_FILENAME   "2afaa99581-private.pem.key" ///< Device private key filename
// =================================================
...
#endif /* AWS_IOT_INCLUDES_AWS_IOT_CONFIG_H_ */
